...
## Diagrama cuando está encendida
```mermaid
stateDiagram-v2
    PreparandoCafe: Preparando café
    Limpieza: Limpieza
    Reposo: Reposo

    apagada --> Reposo : Encender
    Reposo --> PreparandoCafe : Preparar café
    PreparandoCafe --> Limpieza : Finalizar preparación
    Limpieza --> Reposo : Finalizar limpieza
```
